function Z_spm_MDP_VB_trial(MDP)
...
font_size = 12;
subplot(3,2,1),yticks(1:8),yticklabels({'State 1','State 2','State 3','State 4','State 5','State 6','State 7','State 8'}),title('Inference on Hidden States','FontSize',font_size)
subplot(3,2,2),title('Inference on Actions','FontSize',font_size),yticks([1:size(MDP.B{1},3)]),yticklabels({'Action 1','Action 2','Action 3','Action 4'})
subplot(3,2,3),title('Allowable Policies','FontSize',font_size)
subplot(3,2,4),title('Posterior Probability of Policies','FontSize',font_size)
subplot(3,2,5),yticklabels({'Outcome 1','Outcome 2','Outcome 3','Outcome 4','Outcome 5','Outcome 6'}),title('Outcomes and Preferences','FontSize',font_size)
subplot(3,2,6),title('Expected Precision (Simulated Dopamine)','FontSize',font_size)
